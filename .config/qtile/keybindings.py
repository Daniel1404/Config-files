...
from functions import Functions # Import the function that move the window to the next and prev group
...
class Keybindings:
    ...
    def init_keys(self):
        ...
        return [
            ...
            Key([self.mod], "Return", lazy.spawn(self.termite), desc="Launch terminal"),
            ...
            Key([self.mod, self.alt], "d", lazy.spawn("emacs"), desc="Open Doom Emacs"),
            Key([self.mod, self.alt], "v", lazy.spawn("gvim"), desc="Open Gvim"),
            Key([self.mod, self.alt], "n", lazy.spawn(self.termite + " -e nvim"), desc="Open Neovim"),
            Key([self.mod, self.alt], "f", lazy.spawn(self.termite + " -e ./.config/vifm/scripts/vifmrun"), desc="Open vifm"),
            Key([self.mod, self.alt], "b", lazy.spawn("brave"), desc="Open Brave"),
            Key([self.mod, self.alt], "c", lazy.spawn("codium"), desc="Open VS codium"),
            Key([self.mod, self.alt], "p", lazy.spawn("pycharm"), desc="Open Pycharm CE"),
            Key([self.mod, self.alt], "a", lazy.spawn("pavucontrol"), desc="Open Pulse audio GUI controller"),
